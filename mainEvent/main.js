...
function displayEvents() {
  ...
  <a href='../mainEvent/eventdetail.html'><img src='${data.photo}' class="card-img-top" alt="..." width=100px height = 250px style="object-fit: cover;"></a>
  <div style="border:1px solid black; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);z-index: 2;white-space: nowrap;"><a href = "#" class= "btn btn rounded-4 mx-0"style="position: absolute; background-color:orange; font-size: 14px">${data.tag}</a></div>
  <div class="card-body">
    ...
    <div style="font-size: 14px">Buy:<a href="#" class="btn btn-success  rounded-3 mx-2 ">Rs .${data.price}</a></div>
  </div>
</div>`
